...
fig_baseCM.savefig("nonPCA Confusion Matrix.png")
...
fig_PCACM.savefig("PCA Confusion Matrix.png")
...
if not os.path.exists('distributions/cross_validation'):
        os.makedirs('distributions/cross_validation')
if not os.path.exists('distributions/cross_validation/majority'):
        os.makedirs('distributions/cross_validation/majority')

if not os.path.exists('distributions/external_test'):
        os.makedirs('distributions/external_test')
if not os.path.exists('distributions/external_test/majority'):
        os.makedirs('distributions/external_test/majority')
if not os.path.exists('distributions/external_test/best_model'):
        os.makedirs('distributions/external_test/best_model')  
if not os.path.exists('distributions/external_test/best_model/best_accuracy'):
        os.makedirs('distributions/external_test/best_model/best_accuracy')  
if not os.path.exists('distributions/external_test/best_model/best_sensibility'):
        os.makedirs('distributions/external_test/best_model/best_sensibility')  
if not os.path.exists('distributions/external_test/best_model/best_specificity'):
        os.makedirs('distributions/external_test/best_model/best_specificity')  
...
cv_maj_sens_ax.set_title('Sensibility Distribution Cross Validation Majority Vote')
cv_maj_sens_fig.savefig('distributions/cross_validation/majority/sensibility_dist_maj_cv.png')
...
ext_maj_sens_ax.set_title('Sensibility Distribution External Test Majority Vote')
ext_maj_sens_fig.savefig('distributions/external_test/majority/sensibility_dist_maj_ext.png')
...
ext_bacc_sens_ax.set_title('Sensibility Distribution External Test Best Accuracy in Training')
ext_bacc_sens_fig.savefig('distributions/external_test/best_model/best_accuracy/sensibility_dist_bacc_ext.png')
...
ext_bsens_acc_ax.set_title('Accuracy Distribution External Test Best Sensibility in Training')
ext_bsens_acc_fig.savefig('distributions/external_test/best_model/best_sensibility/accuracy_dist_bsens_ext.png')
...
ext_bsens_sens_ax.set_title('Sensibility Distribution External Test Best Sensibility in Training')
ext_bsens_sens_fig.savefig('distributions/external_test/best_model/best_sensibility/sensibility_dist_bsens_ext.png')
...
ext_bsens_spec_ax.set_title('Specificity Distribution External Test Best Sensibility in Training')
ext_bsens_spec_fig.savefig('distributions/external_test/best_model/best_sensibility/specificity_dist_bsens_ext.png')
...
ext_bspec_sens_ax.set_title('Sensibility Distribution External Test Best Specificity in Training')
ext_bspec_sens_fig.savefig('distributions/external_test/best_model/best_specificity/sensibility_dist_bspec_ext.png')
