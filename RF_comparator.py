...
# cross_acc_res = ttest_ind(cross_acc_stat, PCA_acc_stat, equal_var=False, alternative='greater')
# print('Accuracy t-stat: {:.2}, p-value: {:.2}'.format(cross_acc_res.statistic, cross_acc_res.pvalue))
cross_sens_res = ttest_ind(cross_sens_stat, PCA_sens_stat, equal_var=False, alternative='greater')
print('Sensitivity t-stat: {:.2}, p-value histo: {:.2}'.format(cross_sens_res.statistic, cross_sens_res.pvalue))
cross_spec_res = ttest_ind(cross_spec_stat, PCA_spec_stat, equal_var=False, alternative='greater')
...
# ext_acc_res = ttest_ind(cross_acc_ext_stat, PCA_acc_ext_stat, equal_var=False, alternative='greater')
# print('Accuracy t-stat: {:.2}, p-value: {:.2}'.format(ext_acc_res.statistic, ext_acc_res.pvalue))
ext_sens_res = ttest_ind(cross_sens_ext_stat, PCA_sens_ext_stat, equal_var=False, alternative='greater')
print('Sensitivity t-stat: {:.2}, p-value histo: {:.2}'.format(ext_sens_res.statistic, ext_sens_res.pvalue))
ext_spec_res = ttest_ind(cross_spec_ext_stat, PCA_spec_ext_stat, equal_var=False, alternative='greater')
